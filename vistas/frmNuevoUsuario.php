                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 col-sm-6 col-xs-12">
                                        <div class="info-box">
                                            ...
                                            <div class="content">
                                                <div class="text"><h4>Nuevo Usuario</h4></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            <div class="body"> 
                                                <h2 class="card-inside-title"><h5>Información básica de tu Usuario</h5></h2>
                                                <br>
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtNombreNuevoUsuario" class="form-control">
                                                                <label for="txtNombreNuevoUsuario" class="form-label">Nombre</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtApellidoNuevoUsuario" class="form-control">
                                                                <label for="txtApellidoNuevoUsuario" class="form-label">Apellido</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="tel" id="txtTelefonoNuevoUsuario" class="form-control">
                                                                <label for="txtTelefonoNuevoUsuario" class="form-label">Número Teléfonico</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="email" id="txtEmailNuevoUsuario" class="form-control">
                                                                <label for="txtEmailNuevoUsuario" class="form-label">Email</label>
                                                            </div>
                                                        </div>
                                                    </div>                                                
                                                    <div class="body">                                                    
                                                    ...
                                                    <div class="col-xs-6 col-sm-4 col-md-5 col-lg-2">
                                                        <button type="button" class="btn bg-purple btn-block btn-lg waves-effect"><h5>Aceptar</h5></button>
                                                    </div>
                                                    <div class="col-xs-6 col-sm-4 col-md-2 col-lg-2">
                                                        <button type="button" class="btn bg-purple btn-block btn-lg waves-effect"><h5>Cancelar</h5></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
