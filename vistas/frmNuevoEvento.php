                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 col-sm-6 col-xs-12">
                                        <div class="info-box">
                                            ...
                                            <div class="content">
                                                <div class="text"><h4>Nuevo Evento</h4></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            <div class="body"> 
                                                <h2 class="card-inside-title"><h5>Información básica de tu evento</h5></h2>
                                                <br>
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtNombreEvento" class="form-control">
                                                    ...
                                                    <div class="body">
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="text" class="timepicker form-control" placeholder="Hora Inicio">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="body">
                                                        <div class="row clearfix">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="text" class="timepicker form-control" placeholder="Hora fin">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-12">
                                                            <div class="form-group form-float">
                                                                <div class="form-line">
                                                                    <input type="text" id="txtNombreEvento" class="form-control">
                                                                    <label for="txtNombreEvento" class="form-label">Dirección</label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtLugarEvento" class="form-control">
                                                                <label for="txtLugarEvento" class="form-label">Lugar</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtDireccionEvento" class="form-control">
                                                                <label for="txtDireccionEvento" class="form-label">Dirección</label>
                                                            </div>
                                                        </div>
                                                    </div>
