                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-lg-3 col-md-12 col-sm-6 col-xs-12">
                                        <div class="info-box">
                                            ...
                                            <div class="content">
                                                <div class="text"><h4>Nueva Tarea</h4></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="card">
                                            <div class="body"> 
                                                <h2 class="card-inside-title"><h5></h5></h2>
                                                <br>
                                                <div class="row clearfix">
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-float">
                                                            <div class="form-line">
                                                                <input type="text" id="txtAsuntoTarea" class="form-control">
                                                                <label for="txtAsuntoTarea" class="form-label">Asunto</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="body">
                                                        ...
                                                        <div class="row clearfix">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <input type="text" class="datepicker form-control" id="txtFechaLimiteTarea" placeholder="Fecha limite">
                                                                    </div>
                                                                </div>
                                                            </div> 
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <div class="form-line">
                                                                        <textarea rows="4" class="form-control no-resize" id="txtDescripcionTarea" placeholder="Descripción"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>                                                       
                                                        </div>
                                                    ...
                                                    <div class="body">
                                                        <form action="/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                                                            <div class="dz-message">
                                                                ...
                                                                <h3>Soltar archivos aquí o haga clic para cargar.</h3>                                                               
                                                            </div>
                                                            <div class="fallback">
